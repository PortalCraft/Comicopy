...
headers = {
    ...
    'cookie': 'webp=1; _ga=GA1.1.602481794.1735981222; _ga_SS4LL7K6CL=GS1.1.1740210219.12.1.1740211857.60.0.0',
}
...
def search():
    ...
    limit = request.form.get('limit') if request.form.get('manga') is not None else 12
    try:
        params = {
            'offset': '0',
            'platform': '2',
